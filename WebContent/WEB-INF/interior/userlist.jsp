    ...
    <thead>   
        <tr >              
           <th data-options="field:'code1'" width="80">编号</th>      
            ...
            <th data-options="field:'code5'" width="100">手机</th>   
            <th data-options="field:'code7'" width="40">年龄</th>   
            <th data-options="field:'code8'" width="180">地址</th>   
            <th data-options="field:'code9'" width="80">是否管理员</th>   
            <th data-options="field:'code10'" width="80">是否为系统内置</th>   
            <th data-options="field:'code12'" width="100">座机</th>   
            ...
            <th data-options="field:'code17'" width="160">工资卡号</th>   
