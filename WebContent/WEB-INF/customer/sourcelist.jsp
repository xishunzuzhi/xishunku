...
<h3>客户来源列表</h3><br>
	...
	<a target="iframe_a" href="SourceStateController?service=addCustomer&customer"  class="easyui-linkbutton" style=" background:#228fbd;color:#C0C0C0;position:absolute ;top:45px;right: 10px">添加客户</a>  
    ...
    <thead>   
        <tr >              
           <th data-options="field:'code1'" width="80">编号</th>      
            ...
            <th data-options="field:'customer_source_name'" width="80">客户来源</th>   
            <th data-options="field:'customer_source_desc'" width="150">来源说明</th>   
    ...
    <tbody>   
		<c:forEach begin="0" end="${list.size()-1}" var = "i">
					<tr>
						...
						<td>
							<a target="iframe_a" href="SourceStateController?service=updateCustomer&customer&customer_id=${list[i].customer_source_id}" onclick="return update(${list[i].status})" ><img src="easyui/themes/icons/pencil.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;
					        <a  href="SourceStateController?service=deleteCustomer&customer&customer_id=${list[i].customer_source_id}" onclick="return deleteCustomer(${list[i].status})"><img src="easyui/themes/icons/cancel.png"></a>
						</td>			
					</tr>
	...
	<div  style="height:9%; width:102%;position: fixed;bottom:0; background: #FFFFFF;">
		...
		<div style="background:#FFFFFF;height:100px; width:20%;position:absolute ;top:0%;right: 0%; ">
			...
			<li>
				<c:choose>
					<c:when test="${page!=1}">
						<a href="SourceStateController?service=showCustomer&customer&page=${page-1}">上一页</a>
					</c:when>
					<c:otherwise>
				...
				<c:choose>
					...
					<a href="SourceStateController?service=showCustomer&customer&page=${page+1}">下一页</a>
					</c:when>
					<c:otherwise>
