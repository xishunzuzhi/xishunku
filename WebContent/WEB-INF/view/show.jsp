...
<body class="easyui-layout">   
    ...
    <div style="height:30px;width:98%; background:#337ab7;position:absolute ;left:25px;top:23px ;">
       	...
       	<span style="color: #C0C0C0;font-family:粗体;font-size:12px;position:absolute ;left:200px;top:2px">
	       	<a target="iframe_a" href="welcome.jsp">工作台</a>&nbsp;&nbsp;&nbsp;
	       	<a target="iframe_a" href="#">报表</a>&nbsp;&nbsp;&nbsp;
	       	<a target="iframe_a" href="customerController?service=showCustomer">客户信息</a>&nbsp;&nbsp;&nbsp;
	       	<a target="iframe_a" href="InteriorMessageController?service=showRole&user">员工信息</a>&nbsp;&nbsp;&nbsp;
	       	<a target="iframe_a" href="InteriorMessageController?service=show">公告信息</a>&nbsp;&nbsp;&nbsp;
	       	<a target="iframe_a" href="NoticeController?service=queryDrafts&addMessage">发件箱</a>
       	</span >
       
       	<a  href="#" style="color: #C0C0C0;font-family:粗体;font-size:12px;position:absolute ;right:50px;top:1px;text-decoration:none;">
    ...
    <div data-options="region:'west'" style="width:215px; background:#1a2933;">
  		<div id="accordion"  style="background:#1a2933; ">   
	    	...
	    	<div title="内部信息"   style="background:#1a2933;">   
	        	...
	        	<ul class="ul">
	        		<li>
	        			<a target="iframe_a" class="a2" href="InteriorMessageController?service=showRole" >
	        				角色管理
	        			</a>
	        		</li>	        		
	        	</ul>
	    	...
	    	<div title="站内邮件"   style="background:#1a2933;">   
	    	   ...
	    	   <div title="管理员" style="background:#1a2933;">   
	        	<ul class="ul">
	        		<li>
	        			<a target="iframe_a" class="a2" href="NoticeController?service=show" >
	        				公告管理
	        			</a>
	        		</li>	        		
	        	</ul>
	        	<ul class="ul">
	        		<li>
	        			<a target="iframe_a" class="a2" href="RoleController?service=show&department_id" >
	        				部门管理
	        			</a>
	        		</li>	        		
	        	</ul>
	        	<ul class="ul">
	        		<li>
	        			<a target="iframe_a" class="a2" href="RoleController?service=show" >
	        				角色管理
	        			</a>
	        		</li>	        		
	        	</ul>
	        	<ul class="ul">
	        		<li>
	        			<a  target="iframe_a" class="a2" href="UserController?service=show" >
	        				用户管理
	        			</a>
	        		</li>	        		
	        	</ul>    	
