    ...
    <thead>   
        <tr >              
           <th data-options="field:'code1'" width="80">编号</th>      
            ...
            <th data-options="field:'code5'" width="130">手机</th>   
            ...
            <th data-options="field:'code11'" width="80">密码</th>   
    ...
    <tbody>   
		<c:forEach begin="0" end="${list.size()-1}" var = "i">
					...
					<tr>
						...
						<c:forEach begin="0" end="${roles.size()-1}" var = "r">
							<c:if test="${list[i].role_id==roles[r].role_id}">
								<td>${roles[r].role_name}</td>
							</c:if>
						</c:forEach>
						<c:forEach begin="0" end="${department.size()-1}" var = "d">
							<c:if test="${list[i].department_id==department[d].department_id}">
						...
						<td>
							...
							<a target="iframe_a" href="UserController?service=update&id=${list[i].user_id}&department_id=${department[i].department_id}" onclick="return update(${list[i].status})" > <img src="easyui/themes/icons/pencil.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;
					        <a  href="UserController?service=delete&id=${list[i].user_id}" onclick="return deleteUser(${list[i].status})"><img src="easyui/themes/icons/cancel.png"> </a>
